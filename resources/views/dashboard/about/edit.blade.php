        ...
        <div class="p-10">     
          <form method="post" action="/dashboard/about/{{ $about->slug }}" enctype="multipart/form-data">
            ...
            <div class="relative z-0 w-full mb-6 group hidden">
                <input type="text" name="slug" id="slug" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer  @error('slug') is-invalid @enderror" placeholder=" " value="{{ old('slug', $about->slug) }}"/>
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="tanggal_lahir" id="tanggal_lahir" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('tanggal_lahir') is-invalid @enderror" placeholder=" " autofocus value="{{ old('tanggal_lahir', $about->tanggal_lahir) }}"/>
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="jabaran" id="jabaran" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('jabaran') is-invalid @enderror" placeholder=" " autofocus value="{{ old('jabaran', $about->jabaran) }}"/>
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="alamat" id="alamat" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('alamat') is-invalid @enderror" placeholder=" " autofocus value="{{ old('alamat', $about->alamat) }}"/>
              ...
              <label for="image" class="relative overflow-hidden flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 @error('image') is-invalid @enderror">
                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                  <svg aria-hidden="true" class="w-10 h-10 mb-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path></svg>
                      ...
                      @if ($about->image)
                          <img src="{{ asset('storage/' . $about->image) }}" class="img-preview w-full object-cover object-center absolute z-10">
                          @else
