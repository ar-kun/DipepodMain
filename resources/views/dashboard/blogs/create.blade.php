  ...
  <x-slot name="header">
    <div class="w-full flex justify-center items-center">
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        {{ __('Tambah Baru Informasi Desa Nagrak Selatan') }}
      </h2>
        ...
        <div class="p-10">     
          <form method="post" action="/dashboard/posts" enctype="multipart/form-data">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="title" id="title" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('title') is-invalid @enderror" placeholder=" " autofocus value="{{ old('title') }}"/>
